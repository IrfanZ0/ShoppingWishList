package com.halalark.shared.repository.firebase
...
import com.halalark.shared.data.models.firebase.purchaserdata.PurchaserDataInterface
import com.tritongames.shoppingwishlist.presentation.MainActivity
import kotlinx.coroutines.tasks.await
import kotlin.jvm.java
import kotlin.text.get

class Purchaser (private val context: Context): PurchaserDataInterface {
    val TAG = "Purchaser"
    ...
    override suspend fun savePurchaserData(pData: HashMap<String, String>) {
        val db = FirebaseFirestore.getInstance("shoppingwishlist")
